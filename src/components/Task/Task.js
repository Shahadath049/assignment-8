...
const Task = (props) => {
    ...
    return (
        ...
        <div className="p-4 ">
            ...
            <h5 className='py-1 mb-3 ' >Time Required : <span className='font-semibold '>{time}s</span></h5>

            <button onClick={()=> props.handleAddToDetails(props.task)} className=" w-full py-2 text-sm text-blue-100 bg-blue-500 rounded shadow ">
                Add to list
            </button>
        </div>
    </div>
